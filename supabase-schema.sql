-- Supabase Database Setup for Verbose
...
AS $$
BEGIN
  INSERT INTO public.profiles (id, email, username, full_name, avatar_url, is_anonymous)
  VALUES (
    NEW.id,
    NEW.email,
...
-- Create a function to update profile timestamp
