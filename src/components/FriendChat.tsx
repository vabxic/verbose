      ...
      {inCall && callType === 'video' && (
        <div className="fc-video-call-overlay">
          ...
          <div className="fc-call-controls">
            ...
            >
              <svg viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" aria-labelledby="rotateIconTitle" stroke="currentColor" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="currentColor">
                ...
                <path stroke-linecap="round" d="M5 10V9"></path>
                <path stroke-linecap="round" d="M19 15v-1"></path>
              </svg>
            </button>
