...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    let pointers: any[] = [new PointerPrototype()];
    ...
    function supportRenderTextureFormat(gl: any, internalFormat: any, format: any, type: any): any {
    ...
    function compileShader(type: any, source: any, keywords?: any): any {
    ...
    function addKeywords(source: any, keywords: any): any {
    ...
    function createFBO(w: any, h: any, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function createDoubleFBO(w: any, h: any, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function resizeFBO(target: any, w: any, h: any, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function resizeDoubleFBO(target: any, w: any, h: any, internalFormat: any, format: any, type: any, param: any): any {
    ...
    function updateColors(dt: any): void {
    ...
    function splat(x: any, y: any, dx: any, dy: any, color: any): void {
      splatProgram.bind();
    ...
    function updatePointerDownData(pointer: any, id: any, posX: any, posY: any): void {
      pointer.id = id;
      pointer.down = true;
      pointer.moved = false;
    ...
    function updatePointerMoveData(pointer: any, posX: any, posY: any, color: any): void {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
    ...
    function correctDeltaX(delta: any): any {
      let aspectRatio = canvas.width / canvas.height;
      if (aspectRatio < 1) delta *= aspectRatio;
      return delta;
    }

    function correctDeltaY(delta: any): any {
      let aspectRatio = canvas.width / canvas.height;
      if (aspectRatio > 1) delta /= aspectRatio;
      return delta;
    }
    ...
    function getResolution(resolution: any): any {
    ...
    function scaleByPixelRatio(input: any): any {
      const pixelRatio = window.devicePixelRatio || 1;
      return Math.floor(input * pixelRatio);
    }

    function hashCode(s: any): any {
