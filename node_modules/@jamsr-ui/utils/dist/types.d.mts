...
type RenderFunction<Component extends As, Props extends object = object> = {
    <AsComponent extends As = Component>(props: MergeWithAs<React.ComponentPropsWithoutRef<Component>, React.ComponentPropsWithoutRef<AsComponent>, Props, AsComponent>): React.ReactElement | null;
    displayName?: string | undefined;
};
declare function forwardType<Component extends As, Props extends object>(component: React.FunctionComponent<Props & {
    as?: As;
