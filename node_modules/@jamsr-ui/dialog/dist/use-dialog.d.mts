...
import { DialogSlots, DialogVariantProps } from './styles.mjs';
...
type UseDialogProps = Props & DialogVariantProps;
declare const UseDialog: (originalProps: UseDialogProps) => {
    Component: _jamsr_ui_utils.As<any>;
    getDialogProps: PropGetter<react.DetailedHTMLProps<react.HTMLAttributes<HTMLDivElement>, HTMLDivElement>>;
    isOpen: boolean;
    classNames: SlotsToClasses<"body" | "footer" | "header" | "content" | "backdrop" | "closeButton"> | undefined;
    styles: {
        backdrop: (slotProps?: ({
